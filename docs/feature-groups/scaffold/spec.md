...
(`today/`, `announcements/`, `recognitions/`, `chat/`, …) will own.
...
`docs/feature-groups/announcements/spec.md`, `docs/feature-groups/recognitions/spec.md`, …) and will
be written as those groups are picked up.
