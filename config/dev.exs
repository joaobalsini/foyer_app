...
config :foyer, FoyerWeb.Endpoint,
  ...
  debug_errors: true,
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:foyer, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:foyer, ~w(--watch)]}
  ]
...
config :foyer, FoyerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/foyer_web/router\.ex$"E,
      ~r"lib/foyer_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :foyer, dev_routes: true
